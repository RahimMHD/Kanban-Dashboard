...
const courses = [
  {
    ...
    description: "Learn day-to-day course for Angular and framework basics with TypeScript",
    category: "Web",
    rating: 4.4,
    reviews: 8,
    duration: "17h 34m",
  ...
  },
  {
    ...
    duration: "19h 17m",
    progress: 0,
    image: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=400&h=250&fit=crop",
  ...
  },
  {
    ...
    duration: "16h 16m",
    progress: 0,
    image: "https://images.unsplash.com/photo-1489641493513-ba4ee84ccea9?w=400&h=250&fit=crop",
  ...
  },
  {
    ...
    duration: "4h 59m",
    progress: 0,
    image: "https://images.unsplash.com/photo-1516534775068-ba3e7458af70?w=400&h=250&fit=crop",
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold mb-4">
              Education, talents, and career opportunities. <span className="text-blue-300">All in one place.</span>
            </h1>
            ...
            <div className="relative max-w-md mx-auto">
              <input
                ...
                className="w-full px-4 py-3 rounded-lg text-gray-900 pl-4 pr-12"
              />
        ...
        <div className="">
          {/* My Courses Section */}
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6 bg-white p-5 rounded-lg shadow-sm">
              <div>
                <h2 className="text-2xl font-bold">My Courses</h2>
                <p className="text-muted-foreground">Total 6 course you have purchased</p>
              </div>
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  {showCategoryDropdown && (
                    <div className="absolute top-full right-0 mt-1 bg-popover border rounded-lg shadow-lg z-50 min-w-[150px]">
                      <div className="py-1">
                        {['All Courses', 'Web', 'Design', 'Psychology'].map((category) => (
                          <button
                            key={category}
                            onClick={() => {
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">Hide completed</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCourses.map((course) => (
                <div key={course.id} className="bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow shadow-sm">
                  <div className="relative">
                    <img
                      src={course.image}
                      alt={course.title}
                  ...
                  <div className="p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        ...
                        course.category === 'Design' ? 'bg-purple-100 text-purple-700' :
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-blue-100 mb-4">Get the right professional certificate program for you.</p>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 mb-4">Enroll now in the most popular and best rated courses.</p>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-card border rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-lg mb-2">Your First Singing Lesson</h3>
