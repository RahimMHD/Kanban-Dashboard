	...
	return (
		<div className="min-h-screen bg-background flex">
			...
			<div className="flex-1 flex bg-white dark:bg-gray-800">
				<div className="flex-1 p-6">
					...
					<div className="flex items-center justify-between mb-6">
						<div>
							...
							<h1 className="text-2xl font-bold dark:text-white">UI/UX Basic Fundamentals</h1>
							<p className="text-muted-foreground dark:text-white">Prof. Devonne Wallbridge</p>
						</div>
					</div>
					...
					<div className="bg-card border rounded-lg p-6 mb-6 shadow-sm">
						...
						<div className="mb-6">
							<h3 className="font-semibold mb-4 dark:text-white">By the numbers</h3>
							<div className="grid grid-cols-2 gap-6">
								<div className="space-y-3">
									...
									<div className="flex items-center gap-3">
										...
										<div className="text-sm text-muted-foreground dark:text-white">Students: 38,815</div>
									</div>
									<div className="flex items-center gap-3">
						...
						<div>
							<h3 className="font-semibold mb-4 dark:text-white">Description</h3>
							<div className="space-y-4 text-muted-foreground dark:text-white">
								<p>
						...
						<div className="mt-6 pt-6 border-t">
							...
							<div className="flex items-center gap-3">
								...
								<div>
									<div className="font-medium dark:text-white">Devonne Wallbridge</div>
									<div className="text-sm text-muted-foreground dark:text-white">Web Developer, Designer, and Teacher</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div className="w-80 p-6 bg-sidebar-background border-l border-sidebar-border dark:bg-gray-800">
					<div className="mb-4">
						<div className="flex items-center justify-between mb-2">
							<h3 className="font-semibold dark:text-white">Course Content</h3>
							<button
						...
						<div className="text-sm text-muted-foreground dark:text-white">2 / 5 | 273 min</div>
					</div>
							...
							{courseContent.map((lesson) => (
								...
								>
									...
									<div className="flex-1 min-w-0">
										<div className="text-sm font-medium truncate dark:text-white">{lesson.id}. {lesson.title}</div>
										<div className="text-xs text-muted-foreground dark:text-white">{lesson.duration}</div>
									</div>
								</div>
							))}
						</div>
							...
							<div key={index} className="border rounded-lg">
								...
								>
									<div className="flex-1">
										<div className="font-medium text-sm dark:text-white">{section.title}</div>
