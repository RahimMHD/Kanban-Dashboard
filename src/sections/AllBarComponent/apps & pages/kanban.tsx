    ...
    <div className="bg-white p-6 rounded-lg shadow-md max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="md:col-span-1">
          <h2 className="text-lg font-semibold text-gray-700 mb-4">App: 8 Pages</h2>
        ...
        <div className="md:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            {tasks.filter(task => task.category === "UX").map((task) => (
              <div key={task.id} className="bg-white p-3 rounded-md shadow-sm mb-3">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">In Review</h3>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Done</h3>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Add New</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-800 mt-6 mb-4">Add New Item</h3>
